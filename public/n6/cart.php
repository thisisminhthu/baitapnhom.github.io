                            ...
                            <div class="right2">
                                <div class="right2-left">
                                    ...
                                    <div class="right2-item">
                                        ...
                                        if ($row['name_size'] != '') {
                                            // $price_size  = $conn->select("select price from option_size where name = '".$row['name_size']."'");
                                        ...
                                        $price_toping = 0;
                                        if ($row['name_toping'] != '') {
                                            // $price_toping  = $conn->select("select price from option_toping where name = '".$row['name_toping']."'");
